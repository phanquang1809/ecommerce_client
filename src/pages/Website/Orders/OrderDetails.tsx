    ...
    <div>
      <div className="p-4 bg-white rounded-md flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="text-xl rounded font-bold">
          ...
          <div className="md:col-span-2 bg-white p-4 rounded-md">
            ...
            <div className="space-y-2">
              <div className="text-sm font-medium text-gray-800">
                {data?.buyer?.receiver_name}
              </div>
              <div className="text-sm text-gray-500">
                {data?.buyer?.receiver_phone}
              </div>
              <div className="text-sm text-gray-500">
        ...
        <div className="bg-white p-4 rounded-md">
          <div className="flex items-center gap-2 pb-3 border-b">
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                handleChatWithShop(data.shop?.owner_id || 0, queryClient)
              }
            >
            ...
            <Button
              ...
              className="rounded"
              size="sm"
              onClick={() => handleGetShopDetail(data.shop?.slug || "")}
            >
